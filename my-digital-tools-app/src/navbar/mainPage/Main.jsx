    ...
    return (
        <div className='mx-auto container mt-10'>
            <div className='flex border w-sm rounded-2xl'>
                <h2 className='flex text-indigo-600 font-bold py-3 pl-4 gap-3'> 
...
Explore Products
 ...
 <div className=' flex gap-2 pt-3 '>
                        ...
                        <button className='btn border-primary font-bold rounded-2xl'> <img src={player} alt="" srcset="" />Watch Demo</button>
                    </div>
                    </div>
